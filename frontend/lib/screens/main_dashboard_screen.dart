...
class _SkyHavenEntryCard extends StatelessWidget {
  final String userName;
  final String? partnerName;

  const _SkyHavenEntryCard({
  ...
  @override
  Widget build(BuildContext context) {
    final isPartnerConnected = partnerName != null && partnerName!.isNotEmpty;
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          PageRouteBuilder(
            pageBuilder: (_, __, ___) => SkyHavenScreen(
              userName: userName,
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: const Color(0xFF9C6FE4).withOpacity(0.35),
          ),
          boxShadow: [
            BoxShadow(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(16),
                gradient: const LinearGradient(
                  colors: [Color(0xFF9C6FE4), Color(0xFF5C9EE8)],
                ),
              ),
              child: const Center(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    isPartnerConnected
                        ? '✨ Your Spark is Ready'
                        : 'A tiny floating world, built together',
                    style: TextStyle(
                      color: isPartnerConnected
